...
../bin/cipherforge_linux_amd64 -ef -i lorem-ipsum-utf8.txt -o lorem-ipsum-utf8-enc.txt -p asasas12
../bin/cipherforge_linux_amd64 -df -i lorem-ipsum-utf8-enc.txt -o lorem-ipsum-utf8-dec.txt -p asasas12
