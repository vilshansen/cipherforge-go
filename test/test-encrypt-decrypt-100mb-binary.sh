...
../bin/cipherforge_linux_amd64 -ef 100mb-binary-file.bin 100mb-binary-file-enc.bin -p asasas12
../bin/cipherforge_linux_amd64 -df 100mb-binary-file-enc.bin 100mb-binary-file-dec.bin -p asasas12
