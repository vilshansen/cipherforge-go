...
../bin/cipherforge_linux_amd64 -ef 1mb-binary-file.bin 1mb-binary-file-enc.bin -p asasas12
../bin/cipherforge_linux_amd64 -df 1mb-binary-file-enc.bin 1mb-binary-file-dec.bin -p asasas12
