...
../bin/cipherforge_linux_amd64 -ef -i 1000mb-binary-file.bin -o 1000mb-binary-file-enc.bin -p asasas12
../bin/cipherforge_linux_amd64 -df -i 1000mb-binary-file-enc.bin -o 1000mb-binary-file-dec.bin -p asasas12
